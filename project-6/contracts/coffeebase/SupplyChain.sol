...
// import the required solidity files
...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  function buyItem(uint _upc) public payable 
    onlyDistributor
    // Call modifier to check if upc has passed previous supply chain stage
    //To be bought, the item must be marked ready for sale by the farmer
    forSale(_upc)
    ...
    // Transfer money to farmer
        (bool transferred,) = items[_upc].ownerID.call.value(items[_upc].productPrice)("");
        require(transferred);
  ...
  function receiveItem(uint _upc) public 
    ...
    // only retailer role can receive the item 
    onlyRetailer
    {
